...
Goal, introduction to S3, EIDF S3 service, EIDF S3 browser.
...
This section describes how to use the EIDF S3 service via the command-line, using the [AWS Command Line Interface](https://aws.amazon.com/cli/) (AWS CLI).
...
A browser-based client is the EIDF S3 service's own [EIDF S3 Browser](https://portal.eidf.ac.uk/project/s3browser/). The EIDF S3 Browser is part of the EIDF portal and provides a web-based user interface for creating and configuring buckets and uploading, downloading and deleting files.
...
## Use EIDF S3 via the EIDF S3 Browser

The EIDF S3 service is complemented with the [EIDF S3 Browser](https://portal.eidf.ac.uk/project/s3browser/). The EIDF S3 Browser is part of the EIDF portal and provides a web-based user interface for creating and configuring buckets and uploading, downloading and deleting files.
