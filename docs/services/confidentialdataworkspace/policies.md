...
Login activity to the Confidential Data Workspace VMs is copied periodically from each VM to the project router VM `<project_code>-router`, where it is stored in the `ubuntu` user's home directory `/home/ubuntu/log-replications/`.
