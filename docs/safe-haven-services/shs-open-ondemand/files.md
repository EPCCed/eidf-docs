...
!!! Note
    ...
    Your project data files, in a project-specific directory under `/safe_data` are **not** available on SHS-level back-ends (e.g., the Superdome Flex). For these, you will need to stage your data to the SHS-level back-end following your
