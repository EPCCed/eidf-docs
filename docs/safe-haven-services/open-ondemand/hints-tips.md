...
Within Open OnDemand, select 'Help (?)' menu => 'Restart Web Server' to restart your Open OnDemand session, which ends the process and allows you to remove the file, and directory.
