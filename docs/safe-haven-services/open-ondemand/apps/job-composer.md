...
Both 'Edit Files' and 'Open Dir' open the [File Manager](../files.md) pointing at the job context directory on the Open OnDemand host for the currently selected job.
